(function () {
	...
	function Select(options) {
		...
		if (!document.getElementById("svelte-1r3r83f-style")) add_css$2();
	...
	function List_default(options) {
		...
		if (!document.getElementById("svelte-mj7ksi-style")) add_css$6();
	...
	function List_groupedReversed(options) {
		...
		if (!document.getElementById("svelte-66i8ah-style")) add_css$9();
	...
	function List_activeItem(options) {
		...
		if (!document.getElementById("svelte-1sufgn9-style")) add_css$b();
