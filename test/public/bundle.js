(function () {
	...
	function create_main_fragment$2(component, ctx) {
		...
		return {
			c() {
				...
				text = createText("\n\n");
				div = createElement("div");
				div.innerHTML = `<input placeholder="Placeholder text" class="svelte-18jdpam">`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
	...
	function create_main_fragment$3(component, ctx) {
		...
		return {
			c() {
				...
				text = createText("\n\n");
				div = createElement("div");
				div.innerHTML = `<input placeholder="Placeholder text" class="svelte-et2xg0">`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
	...
	function add_css$4() {
		...
		style.textContent = ".selectContainer.svelte-u7khaw{border:1px solid #D8DBDF;border-radius:3px;height:44px;position:relative}.selectContainer.svelte-u7khaw:hover{border-color:#b2b8bf}.selectedItem.svelte-u7khaw{padding:0 16px;line-height:44px}.clearSelectedItem.svelte-u7khaw{position:absolute;right:10px;top:12px;width:20px;height:20px;color:#c5cacf}.clearSelectedItem.svelte-u7khaw:hover{color:#2c3e50}";
		append(document.head, style);
	}
	...
	function create_main_fragment$4(component, ctx) {
		...
		return {
			c() {
				...
				div_2.innerHTML = `<div class="selectedItem svelte-u7khaw">Item #4</div>
