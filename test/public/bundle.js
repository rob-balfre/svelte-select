(function () {
	...
	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-6jslse-style';
		style.textContent = ".container.svelte-6jslse{background:red}";
		append(document.head, style);
	}
	...
	function create_main_fragment(component, ctx) {
		...
		return {
			c() {
				...
				div.innerHTML = `<input placeholder="Placeholder text">`;
				div.className = "container svelte-6jslse";
			},
	...
	function Select(options) {
		...
		if (!document.getElementById("svelte-6jslse-style")) add_css();
	...
	function add_css$1() {
		...
		style.id = 'svelte-sojg5o-style';
		style.textContent = ".container.svelte-sojg5o{background:red}.container.svelte-sojg5o input.svelte-sojg5o{border:none;height:30px;line-height:30px;padding:0 10px}";
	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c() {
				...
				div.innerHTML = `<input placeholder="Placeholder text" class="svelte-sojg5o">`;
				div.className = "container svelte-sojg5o";
			},
	...
	function Select_default(options) {
		...
		if (!document.getElementById("svelte-sojg5o-style")) add_css$1();
	...
	assign$1(Select_default.prototype, proto$1);
