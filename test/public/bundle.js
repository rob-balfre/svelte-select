(function () {
	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c() {
				...
				div.className = "container svelte-ocijb9";
			},
	...
	function create_each_block(component, ctx) {
		...
		return {
			c() {
				...
				div.className = div_class_value = "listItem " + (ctx.activeItemIndex === ctx.i ? 'active' : '') + " svelte-ocijb9";
			},
			...
			p(changed, _ctx) {
				...
				div._svelte.ctx = ctx;
				if ((changed.activeItemIndex) && div_class_value !== (div_class_value = "listItem " + (ctx.activeItemIndex === ctx.i ? 'active' : '') + " svelte-ocijb9")) {
					div.className = div_class_value;
				}
			},
	...
	function List(options) {
		...
		if (!document.getElementById("svelte-ocijb9-style")) add_css$1();
	...
	function add_css$2() {
		var style = createElement("style");
		style.id = 'svelte-a87k8m-style';
		style.textContent = ".container.svelte-a87k8m{border:1px solid #D8DBDF;border-radius:3px;height:44px}.container.svelte-a87k8m input.svelte-a87k8m{border:none;color:#3F4F5F;height:44px;line-height:44px;padding:0 16px;width:100%;background:transparent;font-size:14px;letter-spacing:-0.08px}.container.svelte-a87k8m input.svelte-a87k8m::placeholder{color:#78848F}.container.svelte-a87k8m:hover{border-color:#b2b8bf}.container.svelte-a87k8m input.svelte-a87k8m:focus{outline:none}";
		append(document.head, style);
	}
	...
	function create_main_fragment$2(component, ctx) {
		...
		return {
			c() {
				...
				text = createText("\n\n");
				div = createElement("div");
				div.innerHTML = `<input placeholder="Placeholder text" class="svelte-a87k8m">`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
				div.className = "container svelte-a87k8m";
			},
	...
	function Select_default(options) {
		...
		if (!document.getElementById("svelte-a87k8m-style")) add_css$2();
	...
	function add_css$3() {
		var style = createElement("style");
		style.id = 'svelte-rnpr14-style';
		style.textContent = ".container.svelte-rnpr14{width:430px;border:1px solid #D8DBDF;border-radius:3px;height:44px}.container.svelte-rnpr14 input.svelte-rnpr14{border:none;color:#3F4F5F;height:44px;line-height:44px;padding:0 16px;width:100%;background:transparent;font-size:14px;letter-spacing:-0.08px}.container.svelte-rnpr14 input.svelte-rnpr14::placeholder{color:#78848F}.container.svelte-rnpr14 input.svelte-rnpr14:focus{outline:none}.container.focused.svelte-rnpr14{border-color:#006FE8}";
		append(document.head, style);
	}
	...
	function create_main_fragment$3(component, ctx) {
		...
		return {
			c() {
				...
				text = createText("\n\n");
				div = createElement("div");
				div.innerHTML = `<input placeholder="Placeholder text" class="svelte-rnpr14">`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
				div.className = "container focused svelte-rnpr14";
			},
	...
	function Select_focus(options) {
		...
		if (!document.getElementById("svelte-rnpr14-style")) add_css$3();
	...
	function create_main_fragment$4(component, ctx) {
		...
		return {
			c() {
				...
				div_5.innerHTML = `<div class="listItem svelte-t38k8z">Item #1</div>
			    <div class="listItem svelte-t38k8z">Item #2</div>
			    <div class="listItem svelte-t38k8z">Item #3</div>
			    <div class="listItem svelte-t38k8z">Item #4</div>
			    <div class="listItem svelte-t38k8z">Item #5</div>`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
				div_5.className = "container svelte-t38k8z";
			},
	...
	function create_main_fragment$5(component, ctx) {
		...
		return {
			c() {
				...
				text = createText("\n\n");
				div_5 = createElement("div");
				div_5.innerHTML = `<div class="listItem svelte-ocijb9">Item #1</div>
			    <div class="listItem active svelte-ocijb9">Item #2</div>
			    <div class="listItem svelte-ocijb9">Item #3</div>
			    <div class="listItem svelte-ocijb9">Item #4</div>
			    <div class="listItem svelte-ocijb9">Item #5</div>`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
				div_5.className = "container svelte-ocijb9";
			},
