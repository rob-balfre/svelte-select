(function () {
	...
	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-amx3s1-style';
		style.textContent = ".customItem.svelte-amx3s1{display:flex;align-items:center}img.svelte-amx3s1{width:5px;padding:5px 0;margin:0 10px}.customItem_title.svelte-amx3s1{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.customItem_name.svelte-amx3s1{display:inline-block;font-weight:700;margin-right:10px}.customItem_tagline.svelte-amx3s1{display:inline-block}";
		append(document.head, style);
	}

	function create_main_fragment(component, ctx) {
		var div3, img, img_src_value, img_alt_value, text0, div2, div0, text1_value = ctx.item.name, text1, text2, div1, text3_value = ctx.item.tagline, text3;
		...
		return {
			c() {
				...
				img.src = img_src_value = ctx.item.image_url;
				img.alt = img_alt_value = ctx.item.name;
				img.className = "svelte-amx3s1";
				div0.className = "customItem_name svelte-amx3s1";
				div1.className = "customItem_tagline svelte-amx3s1";
				div2.className = "customItem_title svelte-amx3s1";
				div3.className = "customItem svelte-amx3s1";
			},
			...
			p(changed, ctx) {
				if ((changed.item) && img_src_value !== (img_src_value = ctx.item.image_url)) {
					img.src = img_src_value;
				}

				if ((changed.item) && img_alt_value !== (img_alt_value = ctx.item.name)) {
					img.alt = img_alt_value;
				}

				if ((changed.item) && text1_value !== (text1_value = ctx.item.name)) {
					setData(text1, text1_value);
				}

				if ((changed.item) && text3_value !== (text3_value = ctx.item.tagline)) {
	...
	function CustomItem(options) {
		...
		if (!document.getElementById("svelte-amx3s1-style")) add_css();
	...
	assign(CustomItem.prototype, proto);
	...
	function List(options) {
		...
		if (!document.getElementById("svelte-1q7fygl-style")) add_css$1();
	...
	function create_main_fragment$3(component, ctx) {
		var text_value = ctx.getSelectionLabel(ctx.item), text;
		...
		return {
			...
			p(changed, ctx) {
				if ((changed.getSelectionLabel || changed.item) && text_value !== (text_value = ctx.getSelectionLabel(ctx.item))) {
					setData(text, text_value);
				}
			},
	...
	function MultiSelection(options) {
		...
		if (!document.getElementById("svelte-10o3np5-style")) add_css$2();
	...
	function Select_default(options) {
		...
		if (!document.getElementById("svelte-k3oaj2-style")) add_css$4();
	...
	function Select_focus(options) {
		...
		if (!document.getElementById("svelte-tpcifk-style")) add_css$5();
	...
	function create_main_fragment$8(component, ctx) {
		...
		return {
			c() {
				...
				div_2.innerHTML = `<input autocomplete="off" autocorrect="off" spellcheck="true" placeholder="" class="svelte-zfhbic">
			  <div class="selectedItem svelte-zfhbic">Chips</div>
			  <div class="clearSelect svelte-zfhbic"><svg width="100%" height="100%" viewBox="-2 -2 50 50" focusable="false" role="presentation"><path fill="currentColor" d="M34.923,37.251L24,26.328L13.077,37.251L9.436,33.61l10.923-10.923L9.436,11.765l3.641-3.641L24,19.047L34.923,8.124 l3.641,3.641L27.641,22.688L38.564,33.61L34.923,37.251z"></path></svg></div>`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
				div_2.className = "selectContainer svelte-zfhbic";
			},
	...
	function Select_itemSelected(options) {
		...
		if (!document.getElementById("svelte-zfhbic-style")) add_css$6();
	...
	function create_main_fragment$9(component, ctx) {
		...
		return {
			c() {
				...
				div_7.innerHTML = `<div class="multiSelectItem svelte-r1vopr"><div class="multiSelectItem_label svelte-r1vopr">
			        Pizza
			      </div>
			      <div class="multiSelectItem_clear svelte-r1vopr"><svg width="100%" height="100%" viewBox="-2 -2 50 50" focusable="false" role="presentation" class="svelte-r1vopr"><path d="M34.923,37.251L24,26.328L13.077,37.251L9.436,33.61l10.923-10.923L9.436,11.765l3.641-3.641L24,19.047L34.923,8.124 l3.641,3.641L27.641,22.688L38.564,33.61L34.923,37.251z"></path></svg></div></div>
			    <div class="multiSelectItem svelte-r1vopr"><div class="multiSelectItem_label svelte-r1vopr">
			        Chips
			      </div>
			      <div class="multiSelectItem_clear svelte-r1vopr"><svg width="100%" height="100%" viewBox="-2 -2 50 50" focusable="false" role="presentation" class="svelte-r1vopr"><path d="M34.923,37.251L24,26.328L13.077,37.251L9.436,33.61l10.923-10.923L9.436,11.765l3.641-3.641L24,19.047L34.923,8.124 l3.641,3.641L27.641,22.688L38.564,33.61L34.923,37.251z"></path></svg></div></div>
			  <input autocomplete="off" autocorrect="off" spellcheck="true" placeholder="" class="svelte-r1vopr">
			  <div class="clearSelect svelte-r1vopr"><svg width="100%" height="100%" viewBox="-2 -2 50 50" focusable="false" role="presentation"><path fill="currentColor" d="M34.923,37.251L24,26.328L13.077,37.251L9.436,33.61l10.923-10.923L9.436,11.765l3.641-3.641L24,19.047L34.923,8.124 l3.641,3.641L27.641,22.688L38.564,33.61L34.923,37.251z"></path></svg></div>`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
				div_7.className = "selectContainer multiSelect svelte-r1vopr";
			},
	...
	function Select_multiSelected(options) {
		...
		if (!document.getElementById("svelte-r1vopr-style")) add_css$7();
	...
	function create_main_fragment$a(component, ctx) {
		...
		return {
			c() {
				...
				text = createText("\n\n");
				div = createElement("div");
				div.innerHTML = `<input autocomplete="off" autocorrect="off" spellcheck="true" placeholder="Select..." class="svelte-r1vopr">`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
				div.className = "selectContainer multiSelect svelte-r1vopr";
			},
	...
	function create_main_fragment$b(component, ctx) {
		...
		return {
			c() {
				...
				div_10.innerHTML = `<div class="listItem hover svelte-mj7ksi"><div class="item">Chocolate</div></div>
			  <div class="listItem svelte-mj7ksi"><div class="item">Pizza</div></div>
			  <div class="listItem svelte-mj7ksi"><div class="item">Cake</div></div>
			  <div class="listItem svelte-mj7ksi"><div class="item">Chips</div></div>
			  <div class="listItem svelte-mj7ksi"><div class="item">Ice Cream</div></div>`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
				div_10.className = "listContainer svelte-mj7ksi";
			},
	...
	function List_default(options) {
		...
		if (!document.getElementById("svelte-mj7ksi-style")) add_css$9();
	...
	function List_empty(options) {
		...
		if (!document.getElementById("svelte-1padgs0-style")) add_css$a();
	...
	function create_main_fragment$d(component, ctx) {
		...
		return {
			c() {
				...
				div_12.innerHTML = `<div class="listGroupTitle svelte-66i8ah">Sweet</div>
			  <div class="listItem hover svelte-66i8ah"><div class="item">Chocolate</div></div>
			  <div class="listItem svelte-66i8ah"><div class="item">Cake</div></div>
			  <div class="listItem svelte-66i8ah"><div class="item">Ice Cream</div></div>
			  <div class="listGroupTitle svelte-66i8ah">Savory</div>
			  <div class="listItem svelte-66i8ah"><div class="item">Pizza</div></div>
			  <div class="listItem svelte-66i8ah"><div class="item">Chips</div></div>`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
				div_12.className = "listContainer svelte-66i8ah";
			},

			m(target, anchor) {
				insert(target, link, anchor);
				insert(target, text, anchor);
				insert(target, div_12, anchor);
			},
	...
	function create_main_fragment$e(component, ctx) {
		...
		return {
			c() {
				...
				div_5.innerHTML = `<div class="listGroupTitle svelte-66i8ah">Savory</div>
			  <div class="listItem hover svelte-66i8ah"><div class="item">Pizza</div></div>
			  <div class="listItem svelte-66i8ah"><div class="item">Chips</div></div>`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
				div_5.className = "listContainer svelte-66i8ah";
			},
	...
	function create_main_fragment$f(component, ctx) {
		...
		return {
			c() {
				...
				text = createText("\n\n");
				div_12 = createElement("div");
				div_12.innerHTML = `<div class="listGroupTitle svelte-66i8ah">Savory</div>
			  <div class="listItem hover svelte-66i8ah"><div class="item">Pizza</div></div>
			  <div class="listItem svelte-66i8ah"><div class="item">Chips</div></div>
			  <div class="listGroupTitle svelte-66i8ah">Sweet</div>
			  <div class="listItem svelte-66i8ah"><div class="item">Chocolate</div></div>
			  <div class="listItem svelte-66i8ah"><div class="item">Cake</div></div>
			  <div class="listItem svelte-66i8ah"><div class="item">Ice Cream</div></div>`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
	...
	function create_main_fragment$g(component, ctx) {
		...
		return {
			c() {
				...
				text = createText("\n\n");
				div_10 = createElement("div");
				div_10.innerHTML = `<div class="listItem svelte-1sufgn9"><div class="item">Chocolate</div></div>
			  <div class="listItem active hover svelte-1sufgn9"><div class="item">Pizza</div></div>
			  <div class="listItem svelte-1sufgn9"><div class="item">Cake</div></div>
			  <div class="listItem svelte-1sufgn9"><div class="item">Chips</div></div>
			  <div class="listItem svelte-1sufgn9"><div class="item">Ice Cream</div></div>`;
				link.rel = "stylesheet";
				link.href = "../reset.css";
				div_10.className = "listContainer svelte-1sufgn9";
			},
	...
	function List_activeItem(options) {
		...
		if (!document.getElementById("svelte-1sufgn9-style")) add_css$e();
