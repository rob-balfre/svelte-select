(function (global, factory) {
	...
	/* src\Item.svelte generated by Svelte v2.16.1 */
	...
	/* src\List.svelte generated by Svelte v2.16.1 */
	...
	function add_css() {
		...
		style.id = 'svelte-17ih900-style';
		style.textContent = ".listContainer.svelte-17ih900{box-shadow:0 2px 3px 0 rgba(44, 62, 80, 0.24);border-radius:4px;max-height:250px;overflow-y:auto;background:#fff}.listGroupTitle.svelte-17ih900{color:#8f8f8f;cursor:default;font-size:12px;height:40px;line-height:40px;padding:0 20px;text-overflow:ellipsis;overflow-x:hidden;white-space:nowrap;text-transform:uppercase}.listItem.svelte-17ih900{cursor:default;height:40px;line-height:40px;padding:0 20px;text-overflow:ellipsis;overflow:hidden;white-space:nowrap}.listItem.hover.svelte-17ih900{background:#e7f2ff}.listItem.svelte-17ih900:active{background:#b9daff}.listItem.svelte-17ih900:first-child{border-radius:4px 4px 0 0}.listItem.active.svelte-17ih900{background:#007aff;color:#fff;pointer-events:none}.empty.svelte-17ih900{text-align:center;padding:20px 0;color:#78848F}";
	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c() {
				...
				div.className = "listContainer svelte-17ih900";
			},
	...
	function create_if_block_1(component, ctx) {
		...
		return {
			c() {
				...
				div.className = "empty svelte-17ih900";
			},
	...
	function create_if_block(component, ctx) {
		...
		return {
			c() {
				...
				div.className = "listGroupTitle svelte-17ih900";
			},
	...
	function create_each_block(component, ctx) {
		...
		return {
			c() {
				...
				div.className = div_class_value = "listItem " + itemClasses(ctx.hoverItemIndex, ctx.item, ctx.i, ctx.items, ctx.selectedValue, ctx.optionIdentifier) + " svelte-17ih900";
			},
			...
			p(changed, _ctx) {
				...
				div._svelte.ctx = ctx;
				if ((changed.hoverItemIndex || changed.items || changed.selectedValue || changed.optionIdentifier) && div_class_value !== (div_class_value = "listItem " + itemClasses(ctx.hoverItemIndex, ctx.item, ctx.i, ctx.items, ctx.selectedValue, ctx.optionIdentifier) + " svelte-17ih900")) {
	...
	function List(options) {
		...
		if (!document.getElementById("svelte-17ih900-style")) add_css();
	...
	/* src\Selection.svelte generated by Svelte v2.16.1 */
	...
	/* src\MultiSelection.svelte generated by Svelte v2.16.1 */
	...
	function add_css$1() {
		var style = createElement("style");
		style.id = 'svelte-akfk3t-style';
		style.textContent = ".multiSelectItem.svelte-akfk3t{background:#EBEDEF;margin-right:5px;border-radius:16px;line-height:32px;display:flex;cursor:default;height:32px;margin-top:5px;padding:0 10px 0 15px}.multiSelectItem_label.svelte-akfk3t{margin-right:5px}.multiSelectItem_clear.svelte-akfk3t{border-radius:0 4px 4px 0;width:20px;text-align:center}.multiSelectItem.svelte-akfk3t:hover,.multiSelectItem.active.svelte-akfk3t{background-color:#006FFF;color:#fff}.multiSelectItem.disabled.svelte-akfk3t:hover{background:#EBEDEF;color:#C1C6CC}.multiSelectItem_clear.svelte-akfk3t{border-radius:50%;background:#52616F;width:16px;height:16px;position:relative;top:8px;text-align:center;padding:1px}.multiSelectItem_clear.svelte-akfk3t:hover,.active.svelte-akfk3t .multiSelectItem_clear.svelte-akfk3t{background:#fff}.multiSelectItem_clear.svelte-akfk3t:hover svg.svelte-akfk3t,.active.svelte-akfk3t .multiSelectItem_clear svg.svelte-akfk3t{fill:#006FFF}.multiSelectItem_clear.svelte-akfk3t svg.svelte-akfk3t{fill:#EBEDEF;vertical-align:top}";
		append(document.head, style);
	}
	...
	function create_if_block$1(component, ctx) {
		...
		return {
			c() {
				div = createElement("div");
				div.innerHTML = `<svg width="100%" height="100%" viewBox="-2 -2 50 50" focusable="false" role="presentation" class="svelte-akfk3t"><path d="M34.923,37.251L24,26.328L13.077,37.251L9.436,33.61l10.923-10.923L9.436,11.765l3.641-3.641L24,19.047L34.923,8.124 l3.641,3.641L27.641,22.688L38.564,33.61L34.923,37.251z"></path></svg>`;
				div._svelte = { component, ctx };

				addListener(div, "click", click_handler$1);
				div.className = "multiSelectItem_clear svelte-akfk3t";
			},
	...
	function create_each_block$1(component, ctx) {
		...
		return {
			c() {
				...
				if (if_block) if_block.c();
				text2 = createText("\r\n");
				div0.className = "multiSelectItem_label svelte-akfk3t";
				div1.className = div1_class_value = "multiSelectItem " + (ctx.activeSelectedValue === ctx.i ? 'active' : '') + " " + (ctx.isDisabled ? 'disabled' : '') + " svelte-akfk3t";
			},
			...
			p(changed, ctx) {
				...
				if ((changed.activeSelectedValue || changed.isDisabled) && div1_class_value !== (div1_class_value = "multiSelectItem " + (ctx.activeSelectedValue === ctx.i ? 'active' : '') + " " + (ctx.isDisabled ? 'disabled' : '') + " svelte-akfk3t")) {
	...
	function MultiSelection(options) {
		...
		if (!document.getElementById("svelte-akfk3t-style")) add_css$1();
	...
	/* src\Select.svelte generated by Svelte v2.16.1 */
	...
	function add_css$2() {
		var style = createElement("style");
		style.id = 'svelte-1y98aj-style';
		style.textContent = ".selectContainer.svelte-1y98aj{border:1px solid #D8DBDF;border-radius:3px;height:44px;position:relative;display:flex;padding:0 16px;background:#fff}.selectContainer.svelte-1y98aj input.svelte-1y98aj{cursor:default;border:none;color:#3F4F5F;height:42px;line-height:42px;padding:0 16px;width:100%;background:transparent;font-size:14px;letter-spacing:-0.08px;position:absolute;left:0}.selectContainer.svelte-1y98aj input.svelte-1y98aj::placeholder{color:#78848F}.selectContainer.svelte-1y98aj input.svelte-1y98aj:focus{outline:none}.selectContainer.svelte-1y98aj:hover{border-color:#b2b8bf}.selectContainer.focused.svelte-1y98aj{border-color:#006FE8}.selectContainer.disabled.svelte-1y98aj{background:#F6F7F8;border-color:#F6F7F8;color:#C1C6CC}.selectContainer.disabled.svelte-1y98aj input.svelte-1y98aj::placeholder{color:#C1C6CC}.selectedItem.svelte-1y98aj{line-height:42px;height:42px;text-overflow:ellipsis;overflow-x:hidden;white-space:nowrap;padding-right:20px}.selectedItem.svelte-1y98aj:focus{outline:none}.clearSelect.svelte-1y98aj{position:absolute;right:10px;top:11px;bottom:11px;width:20px;color:#c5cacf;flex:none !important}.clearSelect.svelte-1y98aj:hover{color:#2c3e50}.selectContainer.focused.svelte-1y98aj .clearSelect.svelte-1y98aj{color:#3F4F5F}.indicator.svelte-1y98aj{position:absolute;right:10px;top:11px;width:20px;height:20px;color:#c5cacf}.indicator.svelte-1y98aj svg.svelte-1y98aj{display:inline-block;fill:currentcolor;line-height:1;stroke:currentcolor;stroke-width:0}.spinner.svelte-1y98aj{position:absolute;right:10px;top:11px;width:20px;height:20px;color:#51ce6c;animation:svelte-1y98aj-rotate 0.75s linear infinite}.spinner_icon.svelte-1y98aj{display:block;height:100%;transform-origin:center center;width:100%;position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;-webkit-transform:none}.spinner_path.svelte-1y98aj{stroke-dasharray:90;stroke-linecap:round}.multiSelect.svelte-1y98aj{display:flex;padding:0 35px 0 16px;height:auto;flex-wrap:wrap}.multiSelect.svelte-1y98aj>.svelte-1y98aj{flex:1 1 50px}.selectContainer.multiSelect.svelte-1y98aj input.svelte-1y98aj{padding:0;position:relative}@keyframes svelte-1y98aj-rotate{100%{transform:rotate(360deg)}}";
		append(document.head, style);
	}
	...
	function create_main_fragment$4(component, ctx) {
		...
		return {
			c() {
				...
				input.className = "svelte-1y98aj";
				addListener(div, "click", click_handler);
				div.className = "" + ctx.containerClasses + " svelte-1y98aj";
	...
	function create_if_block_3(component, ctx) {
		...
		return {
			c() {
				...
				div.className = "selectedItem svelte-1y98aj";
			},
	...
	function create_if_block_2(component, ctx) {
		...
		return {
			c() {
				div = createElement("div");
				div.innerHTML = `<svg width="100%" height="100%" viewBox="-2 -2 50 50" focusable="false" role="presentation" class="svelte-1y98aj"><path fill="currentColor" d="M34.923,37.251L24,26.328L13.077,37.251L9.436,33.61l10.923-10.923L9.436,11.765l3.641-3.641L24,19.047L34.923,8.124 l3.641,3.641L27.641,22.688L38.564,33.61L34.923,37.251z"></path></svg>`;
				addListener(div, "click", click_handler);
				div.className = "clearSelect svelte-1y98aj";
			},
	...
	function create_if_block_1$1(component, ctx) {
		...
		return {
			c() {
				div = createElement("div");
				div.innerHTML = `<svg width="100%" height="100%" viewBox="0 0 20 20" focusable="false" class="css-19bqh2r svelte-1y98aj"><path d="M4.516 7.548c0.436-0.446 1.043-0.481 1.576 0l3.908 3.747 3.908-3.747c0.533-0.481 1.141-0.446 1.574 0 0.436 0.445 0.408 1.197 0 1.615-0.406 0.418-4.695 4.502-4.695 4.502-0.217 0.223-0.502 0.335-0.787 0.335s-0.57-0.112-0.789-0.335c0 0-4.287-4.084-4.695-4.502s-0.436-1.17 0-1.615z"></path></svg>`;
				div.className = "indicator svelte-1y98aj";
			},
	...
	function create_if_block$2(component, ctx) {
		...
		return {
			c() {
				div = createElement("div");
				div.innerHTML = `<svg class="spinner_icon svelte-1y98aj" viewBox="25 25 50 50"><circle class="spinner_path svelte-1y98aj" cx="50" cy="50" r="20" fill="none" stroke="currentColor" stroke-width="5" stroke-miterlimit="10"></circle></svg>`;
				div.className = "spinner svelte-1y98aj";
			},
	...
	function Select(options) {
		...
		if (!document.getElementById("svelte-1y98aj-style")) add_css$2();
